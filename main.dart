...
import 'package:roadways_service_provider/login/SignupPage.dart';
import 'package:roadways_service_provider/service/service.dart';
import 'package:roadways_service_provider/login/forget.dart';
    ...
    if (mobilenumber != null) {
      ...
      if (response.statusCode == 200) {
        ...
        if (decodedData is List && decodedData.isEmpty) {
          _showAlertDialog('Error', 'Invalid Email/Mobile Number');
        }
